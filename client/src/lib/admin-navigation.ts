...
export const ADMIN_ROUTE_PERMISSIONS = {
  ...
  dangerousGoodsRequests: { anyOf: ["dangerous-goods-requests:read"] },
  ...
  integrationHealth: { anyOf: ["integrations:read"] },
...
export const ADMIN_NAV_ITEMS = [
  ...
  { href: "/admin/applications", label: "Applications", permissions: ADMIN_ROUTE_PERMISSIONS.applications },
  {
    ...
    children: [
      ...
      { href: "/admin/operations?view=dangerous_goods", label: "Dangerous Goods", permissions: ADMIN_ROUTE_PERMISSIONS.operations },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/admin/dangerous-goods-requests", label: "Dangerous Goods", permissions: ADMIN_ROUTE_PERMISSIONS.dangerousGoodsRequests },
