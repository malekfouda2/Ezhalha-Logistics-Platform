// components/sharedScreens/ChangePasswordScreen.tsx
//
// `useChangePassword` hits a plain `/api/auth/change-password` — not scoped to a portal — so
// this screen is shared verbatim between the client tabs
// (app/(protected)/(client)/change-password.tsx) and the admin shell
// (app/(protected)/(admin)/change-password.tsx) rather than duplicated.
