...
//
// Generic notification inbox — the `/api/notifications` endpoint it reads from is not
// scoped to a portal, so this one screen is shared verbatim between the client tabs
// (app/(protected)/(client)/notifications.tsx) and the admin shell
// (app/(protected)/(admin)/notifications.tsx) rather than duplicated.
import {
  ActivityIndicator,
  FlatList,
  Pressable,
