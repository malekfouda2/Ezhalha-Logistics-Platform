// components/sharedScreens/LanguageScreen.tsx
//
// `useLanguageStore` is app-wide, not portal-scoped — shared verbatim between the client tabs
// (app/(protected)/(client)/language.tsx) and the admin shell
// (app/(protected)/(admin)/language.tsx) rather than duplicated.
