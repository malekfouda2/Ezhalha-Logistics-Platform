// app/create-shipment/dangerousGoods/step-4.tsx
// Mirrors Express's step-4.tsx (Package Details) — same packing-list upload/extraction,
// unit toggle, package type select and weight summary. Continues straight to the
// content-kind step since dangerous goods has no rate step to fetch.
...
import { usePackagesStep } from "@/lib/hooks/createShipment/dangerousGoods/usePackagesStep";
...
export default function DangerousGoodsPackagesScreen() {
