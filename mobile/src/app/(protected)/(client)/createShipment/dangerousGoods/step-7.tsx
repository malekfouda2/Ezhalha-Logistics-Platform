// app/create-shipment/dangerousGoods/step-7.tsx
// Mirrors Express's step-6.tsx (Customs Details) — same invoice upload/extraction,
// item cards and add/edit modal. Only reached for international shipments.
...
import { useCustomsItemsStep } from "@/lib/hooks/createShipment/dangerousGoods/useCustomsItemsStep";
...
export default function DangerousGoodsCustomsScreen() {
