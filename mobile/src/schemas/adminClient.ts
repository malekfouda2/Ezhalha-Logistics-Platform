...
export const createClientSchema = z.object({
  companyName: z.string().trim().min(1, i18n.t("adminClientsScreen.form.errors.companyNameRequired")),
  ...
  phone: z.string().trim().min(6, i18n.t("adminClientsScreen.form.errors.phoneRequired")),
});
