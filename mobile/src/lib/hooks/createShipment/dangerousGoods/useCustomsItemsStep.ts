...
// Mirrors Express's customs step (lib/hooks/createShipment/express/useCustomsStep.ts) —
// same invoice upload/extraction and manual item editing. Only reached for international
// shipments (skipped for domestic).
export function useCustomsItemsStep() {
  ...
  const handleContinue = () => {
    ...
    router.push("/createShipment/dangerousGoods/step-8");
  };

  const handleBack = () => router.push("/createShipment/dangerousGoods/step-6");
